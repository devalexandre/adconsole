...
abstract class AbstractCommand extends Command
{
     ...
     */
    const DEFAULT_MIGRATION_TEMPLATE = '/templates/migrations/Migration.template.php.dist';

    /**
     * The location of the default seed template.
     */
    const DEFAULT_SEED_TEMPLATE = '/templates/migrations/Seed.template.php.dist';
    ...
    {
        $this->addOption('--configuration', '-c', InputOption::VALUE_OPTIONAL, 'The configuration file to load','app/config/migration.php');
        $this->addOption('--parser', '-p', InputOption::VALUE_OPTIONAL, 'Parser used to read the config file. Defaults to YAML','php');
    }
    ...
    {
        return dirname(__FILE__,2). self::DEFAULT_MIGRATION_TEMPLATE;
    }
    ...
    {
        return dirname(__FILE__,2). self::DEFAULT_SEED_TEMPLATE;
    }
}
